...
import HackerNewsCSS from './hackernews.css';
...
export const HackerNews = component$(() => {
  ...
  const state = useStore({
    url: 'https://node-hnapi.herokuapp.com/news?page=0',
  ...
  return (
    <>
      <Nav />
      <Stories data={state.responseJson} />
    </>
  );
});
  ...
  return (
    ...
    <div class="news-view">
      <div class="news-list-nav">
        ...
        <span>page {page}</span>
        {newsStories && newsStories.length >= 29 ? (
